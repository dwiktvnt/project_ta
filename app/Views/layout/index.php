            ...
            <div>
                <div class="mx-auto d-flex flex-lg-row flex-column hero-header-2-2">
                    ...
                    <div class="left-column-header-2-2 d-flex flex-lg-grow-1 flex-column align-items-lg-start text-lg-start align-items-center text-center">
                        <p class="text-caption-header-2-2">SPPK by Dwi Merda</p>
                        <h1 class="title-text-big-header-2-2 d-lg-inline d-none">SISTEM PAKAR DIAGNOSA PENYAKIT KUCING</h1>
                        <h1 class="title-text-small-header-2-2 d-lg-none d-inline">SISTEM PAKAR DIAGNOSA PENYAKIT KUCING</h1>
                        <div class="div-button-header-2-2 d-inline d-lg-flex align-items-center mx-lg-0 mx-auto justify-content-center">
                            <a href="<?= base_url('admin'); ?>" class="btn d-inline-flex mb-md-0 btn-try-header-2-2">Mulai Diagnosa</a>
                            <a href="#informasi" class="btn btn-outline-header-2-2">
                    ...
                    <div class="right-column-header-2-2 text-center d-flex justify-content-center pe-0">
                        <img id="img-fluid" style="display: block;max-width: 100%;height: auto;" src="https://blush.design/api/download?shareUri=norMaer5iJJa4z9-&w=800&h=800&fm=png" alt="">
                    </div>
